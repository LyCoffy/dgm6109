...
x2:         horizontal position for drawing choice2 (type: Number, range: 0-500)
y2:         vertical position for drawing choice2 (type: Number, range: 0-500)
...
function makeDrawing (canvas, choice1, x1, y1, choice2, x2, y2, showOrigin) {
    ...
    // --- Decor choices for drawings ---
    let fishChoice = document.getElementById("choiceFish") ? document.getElementById("choiceFish").value : undefined;
    let rabbitChoice = document.getElementById("choiceRabbit") ? document.getElementById("choiceRabbit").value : undefined;
    let drummerChoice = document.getElementById("choiceDrummer") ? document.getElementById("choiceDrummer").value : undefined;
    let ladybugChoice = document.getElementById("choiceLadybug") ? document.getElementById("choiceLadybug").value : undefined;
    let elephantChoice = document.getElementById("choiceElephant") ? document.getElementById("choiceElephant").value : undefined;


    // --- FIRST ELEMENT ---
    if (choice1 == "fish") {
        fish(item1, x1, y1, showOrigin, fishChoice);
    } else if (choice1 == "rabbit") {
        rabbit(item1, x1, y1, showOrigin, rabbitChoice);
    } else if (choice1 == "butterfly") {
        butterfly(item1, x1, y1, showOrigin);
    } else if (choice1 == "drummer") {
        drummer(item1, x1, y1, showOrigin, drummerChoice);
    } else if (choice1 == "ladybug") {
        ladybug(item1, x1, y1, showOrigin, ladybugChoice);
    } else if (choice1 == "panda") {
        panda(item1, x1, y1, showOrigin);
    } else if (choice1 == "rooster") {
        rooster(item1, x1, y1, showOrigin);
    }
    else if (choice1 == "elephant") {
    elephant(item1, x1, y1, showOrigin, elephantChoice);
    }
    ...
    // --- SECOND ELEMENT ---
    if (choice2 == "fish") {
        fish(item2, x2, y2, showOrigin, fishChoice);
    } else if (choice2 == "rabbit") {
        rabbit(item2, x2, y2, showOrigin, rabbitChoice);
    } else if (choice2 == "butterfly") {
        butterfly(item2, x2, y2, showOrigin);
    } else if (choice2 == "drummer") {
        drummer(item2, x2, y2, showOrigin, drummerChoice);
    } else if (choice2 == "ladybug") {
        ladybug(item2, x2, y2, showOrigin, ladybugChoice);
    } else if (choice2 == "panda") {
        panda(item2, x2, y2, showOrigin);
    } else if (choice2 == "rooster") {
        rooster(item2, x2, y2, showOrigin);
    }
    else if (choice2 == "elephant") {
    elephant(item2, x2, y2, showOrigin, elephantChoice);
    }
